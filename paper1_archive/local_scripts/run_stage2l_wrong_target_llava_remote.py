...
echo '--- Stage 2L LLaVA wrong-target rerun disk/gpu ---'
...
echo '--- Stage 2L LLaVA wrong-target negative control rerun ---'
...
def main() -> int:
    ...
    remote_script = f"{REMOTE_STAGE}/run_stage2l_wrong_target_llava_rerun.sh"
    ...
    while not stdout.channel.exit_status_ready():
        ...
        if time.time() - start > 10800:
            ...
            raise TimeoutError("Stage 2L LLaVA wrong-target rerun exceeded 3 hours")
