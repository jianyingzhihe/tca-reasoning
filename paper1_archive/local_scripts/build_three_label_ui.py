...
HTML_OUT = DATASET_DIR / "three_label_annotation_ui.html"
CSV_TEMPLATE_OUT = DATASET_DIR / "three_label_annotation_blank.csv"
README_OUT = DATASET_DIR / "three_label_annotation_ui_README.txt"
...
QUESTION_TYPE_OPTIONS = [
    ...
    {
        "id": "weak_image_prior",
        "title": "Weak Image Prior",
        "shortcut": "5",
        "description": "Image is mostly a topic anchor; answer relies weakly on image details.",
    },
]
...
VISUAL_STRUCTURE_OPTIONS = [
    ...
    },
    {
        ...
        "title": "Core + Context",
        "shortcut": "E",
        "description": "There is a main core cue, but context also matters for support or disambiguation.",
    },
    {
        "id": "diffuse_global",
...
IMAGE_DEPENDENCE_OPTIONS = [
    ...
    },
    {
        ...
        "title": "Weak",
        "shortcut": "D",
        "description": "Image mostly anchors the topic; answer relies weakly on visual detail.",
    },
]
...
README_TEXT = """Three-Label Annotation UI
=========================
...
How to use
----------
1. Open `three_label_annotation_ui.html` in a browser.
...
Output
------
The exported CSV contains all three labels and notes for each sample.
"""
...
def build_payload(rows: list[dict[str, str]]) -> dict:
    ...
    return {
        "dataset_name": "okvqa_type_label_round3_320_three_label",
        "items": items,
...
<body>
  <div class="app">
    <div class="topbar">
      <div>
        ...
        <div class="sub">Shortcuts: question type 1-5, visual structure Q/W/E/R, image dependence A/S/D, arrows for navigation.</div>
      </div>
      <div class="actions">
  ...
  <script>
    ...
    const STORAGE_KEY = "codex_three_label_" + DATA.dataset_name;
    ...
    function refreshSummary() {{
      const done = Object.values(labels).filter(
        (row) => row.question_type || row.visual_structure || row.image_dependence || row.annotator_notes
      ).length;
